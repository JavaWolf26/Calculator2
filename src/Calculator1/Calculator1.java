		...
		case "9":
			...
			case "9":
				...
				case "/":
					try {
						result = i1 / i2;
						if (i1 % i2 == 0) System.out.print(result);
						else System.out.print(result + "; Ostatoc: " + i1 % i2);
					} catch (ArithmeticException e) {
						System.out.println("Delit' na 0 nelza!");
					}
					break;
				default: System.out.println("Nevernii format arifmeti4eskogo virazenia");
				}
			}
			}else System.out.println("Nevernii format arifmeti4eskogo virazenia");
		}
